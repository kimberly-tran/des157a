...
// menu control [top left icons]
    ...
    // controls rules/instructions overlay
    ...
    // controls theme map overlay
    customize.addEventListener('click', function() {
        gametheme.className = 'showing';
    });

    // collects user input for which theme map & changes the background image + audio accordingly
